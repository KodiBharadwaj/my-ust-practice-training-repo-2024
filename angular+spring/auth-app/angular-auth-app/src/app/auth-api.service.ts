...
export class AuthApiService {
  ...
  registerUser(userSignupCredentials:UserSignupCredentials):Observable<UserCredentials>{
    return this.authClient.post<UserCredentials>(this.baseUrl+"/register", userSignupCredentials);
  }
